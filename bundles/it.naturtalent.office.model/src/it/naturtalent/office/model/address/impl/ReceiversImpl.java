 ...
 * </p>
 * <ul>
 *   <li>{@link it.naturtalent.office.model.address.impl.ReceiversImpl#getReceivers <em>Receivers</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ReceiversImpl extends MinimalEObjectImpl.Container implements Receivers
{
	 ...
	 * @ordered
	 */
	protected EList<Empfaenger> receivers;
	...
	{
		return AddressPackage.Literals.RECEIVERS;
	}
	...
	public EList<Empfaenger> getReceivers()
	{
		if (receivers == null)
		{
			receivers = new EObjectContainmentEList<Empfaenger>(Empfaenger.class, this, AddressPackage.RECEIVERS__RECEIVERS);
		}
		return receivers;
	}
	...
	public void eSet(int featureID, Object newValue)
	{
		switch (featureID)
		{
			case AddressPackage.RECEIVERS__RECEIVERS:
				getReceivers().clear();
				getReceivers().addAll((Collection<? extends Empfaenger>)newValue);
				return;
		}
