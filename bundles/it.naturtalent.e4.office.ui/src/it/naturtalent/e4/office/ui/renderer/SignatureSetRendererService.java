...
public class SignatureSetRendererService extends MultiReferenceSWTRendererService
{
			...
			ViewModelContext viewModelContext)
	{
		...
		if (AddressPackage.eINSTANCE.getSignatureSet_Signatures().equals(feature))
		{
			return 12.0;					
		}
	...
	public Class<? extends AbstractSWTRenderer<VControl>> getRendererClass() {
		return SignatureSetRenderer.class;
	}
}
