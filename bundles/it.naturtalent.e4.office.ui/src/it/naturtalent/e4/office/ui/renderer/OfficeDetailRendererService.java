...
public class OfficeDetailRendererService extends MultiReferenceSWTRendererService
{
			...
			ViewModelContext viewModelContext)
	{
		...
		// Referenzen
		if (AddressPackage.eINSTANCE.getReferenzen_Referenzen().equals(feature))
		{
			return 12.0;				
		}
		
		if (AddressPackage.eINSTANCE.getFootNotes_FootNotes().equals(feature))
		{
		...
		// Signaturen
		if (AddressPackage.eINSTANCE.getSignatures_Signatures().equals(feature))
		{
			return 12.0;				
		}
	...
	public Class<? extends AbstractSWTRenderer<VControl>> getRendererClass() {
		return OfficeDetailRenderer.class;
	}
}
