 ...
 */
public class ReferenzenDetailRendererService implements EMFFormsDIRendererService<VControl>
{
	...
	public double isApplicable(VElement vElement, ViewModelContext viewModelContext)
	{
		...
		if (AddressPackage.eINSTANCE.getReferenzen_Referenzen().equals(eStructuralFeature))
		{
	...
	{
		return ReferenzenDetailRenderer.class;	
	}
